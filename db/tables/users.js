...
module.exports = {
    ...
    association: (models) => {
        ...
        models.settings.hasOne(models.deviceListActiveTabs, { foreignKey:'email',as: 'deviceListActiveTabs',onDelete:'CASCADE' });
        models.settings.hasOne(models.deviceListSort, { foreignKey:'email',as: 'deviceListSort',onDelete:'CASCADE' });

        models.settings.hasMany(models.deviceListColumns, { foreignKey:'email',as: 'deviceListColumns',onDelete:'CASCADE' });
